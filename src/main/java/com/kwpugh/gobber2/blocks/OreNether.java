...
public class OreNether  extends OreBlock
{
	...
	static double chance = Gobber2.CONFIG.GENERAL.dropChanceNemesisNether;
	...
	{
		tooltip.add(new TranslatableText("item.gobber2.gobber2_ore_nether.tip1").formatted(Formatting.GREEN));
		tooltip.add(new TranslatableText("item.gobber2.gobber2_ore_nether.tip2").formatted(Formatting.YELLOW));
	}	  
}